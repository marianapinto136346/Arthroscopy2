...
if execution_clicked:
    if not uploaded_file:
        ...
        try:
            ...
            # Executa capturando mensagens de erro caso o script backend falhe internamente
            ...
            if not os.path.exists(log_absoluto):
                ...
                if df.empty:
                    ...
                    st.markdown("##### 🎬 Processed Videos by Metric:")
            ...
            status_warning.empty()
            st.error("System Failure inside Python Pipeline Script:")
